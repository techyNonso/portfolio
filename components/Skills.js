      ...
      <section className="skills section" id="skills">
        ...
        <div className="skills__container container grid">
                ...
                <div className="skills__header">
                  ...
                  <div className="skills__list grid">
                    ...
                    <div className="skills__data">
                      ...
                      <div className="skills__bar">
                        <span className="skills__percentage skills__bstrap"></span>
                      </div>
                ...
                <i className="uil uil-server-network skills__icon"></i>
                  ...
                  <div className="skills__list grid">
                    ...
                    <div className="skills__data">
                      ...
                      <div className="skills__bar">
                        <span className="skills__percentage skills_django"></span>
                      </div>

                    </div>
                    <div className="skills__data">
                      <div className="skills_titles">
                        <h3 className="skills__name">MySQLI</h3>
                        <span className="skills__number">85%</span>
                      </div>
                      <div className="skills__bar">
                        <span className="skills__percentage skills_sqli"></span>
                      </div>
                    ...
                    <div className="skills__data">
                      <div className="skills_titles">
                        <h3 className="skills__name">Couch DB</h3>
                        <span className="skills__number">90%</span>
                      </div>
                      <div className="skills__bar">
                        <span className="skills__percentage skills_couch"></span>
                      </div>
                    ...
                    <div className="skills__data">
                      <div className="skills_titles">
                        <h3 className="skills__name">Postgress DB</h3>
                        <span className="skills__number">70%</span>
                      </div>
                      <div className="skills__bar">
                        <span className="skills__percentage skills_postgress"></span>
                      </div>
            ...
            <div>
              ...
              <div className="skills__content skills__close">
                <div className="skills__header">
                <i className="uil uil-link skills__icon"></i>
                  ...
                  <div className="skills__list grid">
                    <div className="skills__data">
                      ...
                      <div className="skills__bar">
                        <span className="skills__percentage skills__solidity"></span>
                      </div>
                    </div>

                    <div className="skills__data">
                      <div className="skills_titles">
                        <h3 className="skills__name">Ganache</h3>
                        <span className="skills__number">70%</span>
                      </div>
                      <div className="skills__bar">
                        <span className="skills__percentage skills__ganache"></span>
                      </div>
                    </div>
                    ...
                    <div className="skills__data">
                      <div className="skills_titles">
                        <h3 className="skills__name">Metamask</h3>
                        <span className="skills__number">80%</span>
                      </div>
                      <div className="skills__bar">
                        <span className="skills__percentage skills__metamask"></span>
                      </div>
                    </div>
                  </div>
              </div>
